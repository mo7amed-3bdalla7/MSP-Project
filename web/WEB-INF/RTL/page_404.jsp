...
<head>
    <title>404 Error Page 2 | Unify - Rabins XP Responsive Website Template</title>
    ...
    <!-- CSS Page Style -->
    <link rel="stylesheet" href="../assets/css/css-rtl/pages/page_error3_404-rtl.css">
    ...
    <div class="row service-block-v2">
        <div class="col-md-4">
            <div class="service-block-in service-or">
                ...
                <p>If the page is not what you are looking for, try searching the page on the search page and find out
                    new things.</p>
        ...
        <div class="col-md-4">
            <div class="service-block-in service-or">
                ...
                <h4>Contact us</h4>
                <p>If you have a problem with the website, please contact us, our support team will help you to solve
                    the problem.</p>
